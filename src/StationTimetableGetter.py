...
def parse_infofer_html(html, station_name):
    ...
    for item in items:
        try:
            ...
            if 'softrans' in text_lower: operator = "Softrans"
            elif 'astra' in text_lower: operator = "Astra Trans Carpatic"
            elif 'regio' in text_lower: operator = "Regio Călători"
            elif 'tfc' in text_lower or 'transferoviar' in text_lower: operator = "Transferoviar Călători"
            elif 'interregional' in text_lower: operator = "Interregional Călători"
